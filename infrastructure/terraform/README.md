...
- `mentisdb/` provisions the new Hetzner VPS for MentisDB, bakes service configuration into cloud-init `user_data`, and manages the `mem.beerpub.dev` Cloudflare A record.
